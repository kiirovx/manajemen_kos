...
<head>
    ...
    <title>Reset Password - KosKita</title>
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-left">
            ...
            <h2>Password Baru</h2>
            <p>Masukkan password baru yang aman untuk menggantikan password lama akun KosKita Anda.</p>
        </div>
        ...
        <div class="login-right">
            <div class="login-header">
                ...
                <p>Silakan isi detail password baru Anda</p>
            </div>
